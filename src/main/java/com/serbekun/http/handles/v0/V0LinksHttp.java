...
import com.serbekun.http.handles.v0.dto.Links.V0LinksDeleteRequest;
import com.serbekun.http.handles.v0.dto.Links.V0LinksPostRequest;
import com.serbekun.http.handles.v0.dto.Links.V0LinksPutRequest;
...
public class V0LinksHttp {
    ...
    private void handleDelete(Context ctx) {
        ...
        com.serbekun.service.http.handles.v0.dto.links.V0LinksDeleteRequest request =
            new com.serbekun.service.http.handles.v0.dto.links.V0LinksDeleteRequest(
                uuid,
                token
            );
